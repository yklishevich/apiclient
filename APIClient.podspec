#
#  Be sure to run `pod spec lint NSString+KMKUtils.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Eugene Klishevich"
  # s.authors            = { "Eugene Klishevich" => "eklishevich@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Eugene Klishevich"
  ...
  s.source       = { :git => "https://github.com/yklishevich/apiclient.git", :tag => "1.0.2" }
